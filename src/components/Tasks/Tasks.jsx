...
const Tasks = ({ tasks, deleteHandler, updateTaskById, onComplete }) => {
  ...
  return (
    <>
      ...
      <p className="text-sm text-white absolute bottom-0 right-0 p-2">
        Made with ❤️ by{" "}
        <span className="font-semibold bg-gradient-to-r bg-clip-text text-transparent from-blue-500 to-violet-400">
          Hemesh Thakur
        </span>
      </p>
    </>
